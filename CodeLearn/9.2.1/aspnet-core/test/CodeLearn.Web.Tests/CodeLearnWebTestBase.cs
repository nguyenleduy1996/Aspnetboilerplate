...
{
    public abstract class CodeLearnWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static CodeLearnWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(CodeLearnWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<CodeLearnDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<CodeLearnDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<CodeLearnDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<CodeLearnDbContext, Task<T>> func)
        {
            T result;
